...
export async function GET(_: Request, { params }: RouteParams) {
  ...
  const res = await fetch(`${apiUrl}/matters/${matterId}/demand-drafts`, {
    method: "GET",
    cache: "no-store",
    headers: withServerAuthHeaders(undefined, { userId: session.user.id, firmId: firmId || "" }, "GET", `/matters/${matterId}/demand-drafts`),
  });
